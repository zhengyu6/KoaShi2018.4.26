...
public class OkUtils {
    ...
    public static void UploadSJ(String url, Map<String, String> map, Callback callback) {
        ...
        Request request = new Request.Builder ()
                ...
                .post ( builder.build () )
                .build ();
        //readTime("请求超时时间,事件单位)
        Call call = getInstance ()
                .newBuilder ().readTimeout ( 5000, TimeUnit.MILLISECONDS ).build ()
                .newCall ( request );
    ...
    public static void UploadFileCS(String url, String key1, String path, Map<String, String> map, Callback callback) {
        ...
        //readTime("请求超时时间,事件单位)
        Call call = getInstance ().newBuilder ().readTimeout ( 5000,TimeUnit.MILLISECONDS ).build ().newCall ( request );
        call.enqueue ( callback );
    }
